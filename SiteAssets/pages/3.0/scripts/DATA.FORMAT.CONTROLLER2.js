...
function printHazardRow(h) {
    ...
    if (h.cdmStageMitigationSuggestion && h.cdmStageMitigationSuggestion !== 'Awaiting assessment') {
        DMMitigationSuggestion = h.cdmStageMitigationSuggestion;
    }
    ...
    var hazardHtml2 = 
        ...
        "                    </td>" +
        '                    <td class="width-250 fld">' +
        '                        <div class="cell cdmSMMitigationSuggestion stagehide pointer" title="Provided by Principal Designer if required">' +
