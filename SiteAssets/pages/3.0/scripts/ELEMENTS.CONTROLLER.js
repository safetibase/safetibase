...
function mkSelect (lst, data, fset, trg) {
    ...
    var multiSelectFields = ['cdmSites','cdmRouteSection','cdmRouteSections','cdmWorkPackage','cdmWorkPackages', 'cdmPWStructures','cdmAssetTypeGroup','cdmAssetSubGroup','cdmAssetType'];
